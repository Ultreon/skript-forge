 ...
 */
public class BlockSphereIterator extends CheckedIterator<BlockInstance> {
	
	public BlockSphereIterator(final Location center, final double radius) {
		super(new AABB(center, radius + 0.5001, radius + 0.5001, radius + 0.5001).iterator(), new NullableChecker<BlockInstance>() {
