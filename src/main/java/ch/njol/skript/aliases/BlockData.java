...
//
//public class BlockData implements Cloneable, YggdrasilExtendedSerializable {
//	
//	static {
//		Variables.yggdrasil.registerSingleClass(BlockData.class, "BlockData");
//	}
//
...
//	int itemFlags;
//	
//	public BlockData(Block type, @Nullable String tags) {
//		this.type = type;
//		
//		this.stack = new ItemStack(type.asItem());
...
//	}
//	
//	public BlockData(Block type, int amount) {
//		this.type = type;
//
//		this.stack = new ItemStack(type.asItem(), Math.abs(amount));
//		this.blockValues = BlockCompat.INSTANCE.getBlockValues(stack);
//	}
//	
...
//	}
//	
//	public BlockData(ItemStack stack, @Nullable BlockValues values) {
//		this.stack = stack;
//		this.type = stack.getItem() instanceof BlockItem blockItem ? blockItem.getBlock() : Blocks.AIR;
//
...
//	}
//	
//	public BlockData(BlockState block) {
//		this.type = block.getBlock();
//		this.stack = new ItemStack(type.asItem());
//		this.blockValues = BlockCompat.INSTANCE.getBlockValues(block);
//	}
//
//	public BlockData(BlockInstance block) {
//		this(block.getState());
//	}
//
//	/**
...
//			if (stack.hasTag() == item.hasTag()) // Compare ItemMeta as in isSimilar() of ItemStack
//				return !stack.hasTag() || Objects.requireNonNull(stack.getTag()).equals(item.getTag());
//			else
//				return false;
//		}
//		return true;
...
//	
//	/**
//	 * Returns <code>Aliases.{@link Aliases#getBlockName(BlockData, boolean) getBlockName}(ItemData, boolean)</code>
...
//		StringBuilder builder = new StringBuilder(Aliases.getBlockName(this, plural));
//		CompoundTag tag = stack.getTag();
//		if (tag != null && stack.hasCustomHoverName()) {
...
//	 * 	{@link Block}, {@link CompoundTag} and {@link BlockValues}.
//	 * <tr><td>{@link MatchQuality#SAME_ITEM}
//	 * 	<td>This and the given item share a {@link Block}. {@link CompoundTag}
//	 * 	of this item contains all values that {@link CompoundTag} of given has.
...
//	 * </table>
//	 */
//	public MatchQuality matchAlias(BlockData item) {
...
//			MatchQuality metaQuality = compareItemMetas(stack, item.stack);
//			
...
//
//	/**
//	 * Compares {@link CompoundTag}s for {@link #matchAlias(BlockData)}.
...
//	 */
//	private static MatchQuality compareItemMetas(ItemStack first, ItemStack second) {
//		MatchQuality quality = MatchQuality.EXACT; // Lowered as we go on
//		MatchQuality newQuality; // Used to prevent upgrading the quality
//
//		// Display name
//		String ourName = first.hasCustomHoverName() ? first.getDisplayName().getString() : null;
//		String theirName = second.hasCustomHoverName() ? second.getDisplayName().getString() : null;
...
//
//		// Lore
//		List<String> ourLore = Forge.hasLore(first) ? Forge.getLore(first) : null;
//		List<String> theirLore = Forge.hasLore(second) ? Forge.getLore(second) : null;
...
//
//		// Enchantments
//		Map<Enchantment, Integer> ourEnchants = first.getAllEnchantments();
//		Map<Enchantment, Integer> theirEnchants = second.getAllEnchantments();
...
//	 */
//	@Nullable
//	public BlockData intersection(final BlockData other) {
...
//	 * For these ItemDatas to match, they must share a {@link Block}. One of the following must also be true:
//	 * <ul>
...
//	 * @see ch.njol.skript.expressions.ExprPlain
//	 */
//	public boolean matchPlain(BlockData other) {
...
//		fields.putPrimitive("id", Objects.requireNonNull(ForgeRegistries.BLOCKS.getKey(type)));
//		fields.putObject("meta", stack.getTag());
//		return fields;
//	}
//
//	private static final Map<ResourceLocation, Block> materials = ForgeRegistries.BLOCKS.getEntries().stream()
//		.map(e -> new Pair<>(e.getKey().location(), e.getValue()))
//		.collect(Collectors.toMap(Pair::getKey, Pair::getValue));
//
//	@Override
//	public void deserialize(Fields fields) throws StreamCorruptedException, NotSerializableException {
//		this.type = materials.get(fields.getAndRemovePrimitive("id", ResourceLocation.class));
//		CompoundTag meta = fields.getAndRemoveObject("meta", CompoundTag.class);
//
//		// Initialize ItemStack
//		this.stack = new ItemStack(type);
//		stack.setTag(meta); // Just set meta to it
//
//		fields.setFields(this); // Everything but ItemStack and Block
//	}
//	
//	/**
...
//	 */
//	public BlockData aliasCopy() {
//		BlockData data = new BlockData();
//		data.stack = new ItemStack(type, 1);
//		
//		if (stack.hasTag()) {
//			CompoundTag meta = stack.getTag(); // Creates a copy
//			stack.resetHoverName(); // Clear display name
//			data.stack.setTag(meta);
//		}
...
//	 */
//	public void applyMeta(CompoundTag meta) {
//		setItemMeta(meta);
//	}
//	
//	/**
