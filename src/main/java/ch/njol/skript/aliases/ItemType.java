...
//	public ItemType() {}
//
//	public ItemType(Item id) {
//		add_(new ItemData(id));
//	}
//
//	public ItemType(Item id, String tags) {
...
//	}
//
//	public ItemType(BlockInstance block) {
//		this(block.getState());
//	}
//
//	/**
...
//			if (d.type instanceof BlockItem)
//				return true;
//		}
//		return false;
//	}
...
//			Item blockType = ItemUtils.asBlock(d.type);
...
//						continue;
//					SkullBlock skull = (SkullBlock) block.getState();
...
//		for (int i = random.nextInt(types.size()); i < types.size(); i++) {
//			ItemData d = types.get(i);
//			BlockItem blockType = ItemUtils.asBlock(d.type);
//			if (blockType == null) // Ignore items which cannot be placed
//				continue;
...
//	 */
//	public boolean hasSpace(final AbstractContainerMenu invi) {
//		if (!isAll()) {
...
//	}
//
//	public static ItemStack[] getCopiedContents(AbstractContainerMenu invi) {
...
//	 * @param invi AbstractContainerMenu
//	 * @return Copied storage contents
//	 */
//	public static ItemStack[] getStorageContents(final AbstractContainerMenu invi) {
