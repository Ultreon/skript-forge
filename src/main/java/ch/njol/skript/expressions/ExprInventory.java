...
//		List<AbstractContainerMenu> inventories = new ArrayList<>();
//		for (InventoryHolder holder : holders.getArray(e)) {
//			inventories.add(holder.getInventory());
//		}
//		AbstractContainerMenu[] invArray = inventories.toArray(new AbstractContainerMenu[0]);
//		if (inLoop) {
//			/*
...
//	@Override
//	public Class<?> getReturnType() {
//		return inLoop ? Slot.class : AbstractContainerMenu.class;
//	}
////
//	@Override
//	public String toString(@Nullable Event e, boolean debug) {
