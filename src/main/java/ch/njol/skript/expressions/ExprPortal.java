...
//public class ExprPortal extends SimpleExpression<BlockInstance> {
////
...
////
//	static {
//		Skript.registerExpression(ExprPortal.class, BlockInstance.class, ExpressionType.SIMPLE,
//				"[the] portal['s] blocks",
...
//					.toArray(BlockInstance[]::new);
//		return blocks.stream()
//				.map(BlockInstance.class::cast)
//				.toArray(BlockInstance[]::new);
//	}
////
//	@Nullable
//	@Override
//	public Iterator<BlockInstance> iterator(Event e) {
//		if (!(e instanceof PortalCreateEvent))
//			return null;
////
//		List<?> blocks = ((PortalCreateEvent) e).getBlocks();
...
//					.map(block -> ((BlockState) block).getBlock())
//					.iterator();
//		return (Iterator<BlockInstance>) blocks.iterator();
//	}
////
//	@Override
