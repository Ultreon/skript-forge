...
//public class ExprBlocks extends SimpleExpression<BlockInstance> {
//	static {
//		Skript.registerExpression(ExprBlocks.class, BlockInstance.class, ExpressionType.COMBINED,
...
//			final BlockInstance[] bs = new BlockInstance[ls.length];
...
//		if (iter == null)
//			return new BlockInstance[0];
//		for (final BlockInstance b : new IteratorIterable<>(iter))
//			r.add(b);
...
//				if (o == null)
//					return null;
//				final Location l = o instanceof Location ? (Location) o : ((BlockInstance) o).getLocation().add(0.5, 0.5, 0.5);
//				final Direction d = direction.getSingle(e);
//				if (d == null)
//					return null;
//				return new BlockLineIterator(l, o != l ? d.getDirection((BlockInstance) o) : d.getDirection(l), SkriptConfig.maxTargetBlockDistance.value());
//			} else {
