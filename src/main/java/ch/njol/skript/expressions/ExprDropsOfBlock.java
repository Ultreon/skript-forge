...
//
//	private final static boolean DROPS_OF_ENTITY_EXISTS = Skript.methodExists(BlockInstance.class, "getDrops", ItemStack.class, Entity.class);
//
//	static {
...
//	private Expression<BlockInstance> block;
//	@SuppressWarnings("null")
...
//		block = (Expression<BlockInstance>) exprs[0];
...
//		@Nullable
//		BlockInstance[] blocks = this.block.getArray(e);
//		if (block != null) {
//			if (this.item == null) {
