...
//		try {
//			_METHOD = MethodHandles.lookup().findVirtual(AbstractContainerMenu.class, "getTitle", MethodType.methodType(String.class));
...
//		} else if (o instanceof BlockInstance) {
//			BlockState state = ((BlockInstance) o).getState();
...
//		} else if (o instanceof AbstractContainerMenu) {
...
//				}
//			} else {
//				if (!((AbstractContainerMenu) o).getViewers().isEmpty())
//					return ((AbstractContainerMenu) o).getViewers().get(0).getOpenInventory().getTitle();
//				return null;
//			}
...
//				switch (mark) {
//					case 2: 
//						((Player) o).setDisplayName(name != null ? name + ChatFormatting.RESET : ((Player) o).getName());
//						break;
...
//				i.setItemMeta(m);
//			} else if (o instanceof AbstractContainerMenu) {
//				AbstractContainerMenu inv = (AbstractContainerMenu) o;
//
