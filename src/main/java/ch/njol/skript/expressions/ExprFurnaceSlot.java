...
//public class ExprFurnaceSlot extends PropertyExpression<BlockInstance, Slot> {
...
//		}
//		if (!isEvent)
//			setExpr((Expression<BlockInstance>) exprs[0]);
//		return true;
//	}
//	
...
//	
//	@Override
//	protected Slot[] get(final Event e, final BlockInstance[] source) {
//		return get(source, new Getter<Slot, BlockInstance>() {
//			@Override
//			@Nullable
//			public Slot get(final BlockInstance b) {
