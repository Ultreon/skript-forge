...
//@Since("2.3")
//public class ExprBurnCookTime extends PropertyExpression<BlockInstance, Timespan> {
//
//	static {
...
//		}
//		if (!isEvent)
//			setExpr((Expression<? extends BlockInstance>) exprs[0]);
//		return true;
//	}
//
//	@Override
//	protected Timespan[] get(Event e, BlockInstance[] source) {
//		if (isEvent) {
...
//		}
//
//		for (BlockInstance block : getExpr().getArray(e)) {
