...
// * @author bi0qaw
// */
//@Name("Vectors - Vec3 Between Locations")
...
////
//	static {
//		Skript.registerExpression(ExprVectorBetweenLocations.class, Vec3.class, ExpressionType.SIMPLE,
...
//		if (l1 == null || l2 == null)
//			return null;
//		return CollectionUtils.array(new Vec3(l2.getX() - l1.getX(), l2.getY() - l1.getY(), l2.getZ() - l1.getZ()));
//	}
////
//	@Override
