...
//			return CollectionUtils.array(Color.class);
//		else if (BlockInstance.class.isAssignableFrom(returnType))
//			return CollectionUtils.array(Color.class);
...
//			} else if (o instanceof BlockInstance || o instanceof Colorable) {
//				Colorable colorable = getColorable(o);
//
//				if (colorable != null) {
//					try {
...
//		} else if (colorable instanceof BlockInstance) {
//			BlockState state = ((BlockInstance) colorable).getState();
//
