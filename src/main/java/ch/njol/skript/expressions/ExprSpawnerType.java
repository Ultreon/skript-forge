...
//@Since("2.4")
//public class ExprSpawnerType extends SimplePropertyExpression<BlockInstance, EntityData> {
////
...
//	@Override
//	@Nullable
//	public EntityData convert(final BlockInstance b) {
...
//		for (BlockInstance b : getExpr().getArray(e)) {
//			if (b.getType() != MATERIAL_SPAWNER)
//				continue;
