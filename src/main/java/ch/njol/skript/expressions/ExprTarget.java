...
////
//		Vec3 direction = entity.getLocation().getDirection().normalize();
//		Vec3 eye = entity.getEyeLocation().toVector();
...
//				Vec3 t = other.getLocation().add(0, 1, 0).toVector().subtract(eye);
