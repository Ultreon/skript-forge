...
//			case 0:
//				direction = new Vec3(byMark[parseResult.mark].getModX(), byMark[parseResult.mark].getModY(), byMark[parseResult.mark].getModZ());
//				if (exprs[1] != null) {
...
//		if (direction != null) {
//			final Vec3 v = direction.clone().multiply(ln);
...
//				final BlockFace f = Direction.getFacing((BlockInstance) o);
...
//				if (!horizontal) {
//					if (!facing) {
//						final Vec3 v = l.getDirection().normalize().multiply(ln);
//						assert v != null;
//						return new Direction[] {new Direction(v)};
//					}
