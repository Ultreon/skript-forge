...
//
//@Name("AbstractContainerMenu Holder/Viewers/Rows/Slots")
...
//	private Expression<AbstractContainerMenu> inventories;
//	private int type;
//
//	@Override
//	public boolean init(Expression<?>[] exprs, int matchedPattern, Kleenean isDelayed, ParseResult parseResult) {
//		inventories = (Expression<AbstractContainerMenu>) exprs[0];
...
//		AbstractContainerMenu[] inventories = this.inventories.getArray(e);
//		List<Object> objects = new ArrayList<>();
//		switch (type) {
//			case HOLDER:
//				for (AbstractContainerMenu inventory : inventories) {
