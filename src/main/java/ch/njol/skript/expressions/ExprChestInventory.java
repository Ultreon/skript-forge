...
//@Since("2.2-dev34")
//public class ExprChestInventory extends SimpleExpression<AbstractContainerMenu> {
//
//	static {
//		Skript.registerExpression(ExprChestInventory.class, AbstractContainerMenu.class, ExpressionType.COMBINED,
...
//
//	@Override
//	protected AbstractContainerMenu[] get(Event e) {
