...
//			} else if (single instanceof Vec3) {
//				changeVector(((Vec3) single), value, mode);
//			}
//		}
//	}
////
...
//	}
////
//	private void changeVector(Vec3 vector, float n, ChangeMode mode) {
...
//				Vec3 newVector = VectorMath.fromYawAndPitch(yaw, pitch).multiply(vector.length());
