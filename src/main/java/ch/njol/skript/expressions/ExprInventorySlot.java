...
////
//@Name("AbstractContainerMenu Slot")
...
//	@SuppressWarnings("null")
//	private Expression<AbstractContainerMenu> invis;
////
...
//			 invis = (Expression<AbstractContainerMenu>) exprs[1];
//		} else {
//			 slots = (Expression<Number>) exprs[1];
//			 invis = (Expression<AbstractContainerMenu>) exprs[0];
//		}
//		return true;
//	}
////
...
//		AbstractContainerMenu invi = invis.getSingle(event);
//		if (invi == null)
//			return null;
////
...
//					HumanEntity holder = ((Inventory) invi).getHolder();
//					assert holder != null;
