...
//			BlockData data = ((BlockInstance) o).getBlockData();
...
//		if (!BlockInstance.class.isAssignableFrom(getExpr().getReturnType()))
//			return null;
...
//		assert delta != null;
////
//		final BlockInstance b = (BlockInstance) getExpr().getSingle(e);
//		if (b == null)
//			return;
...
//	}
////
//	private static BlockFace toBlockFace(final Vec3 dir) {
////		dir.normalize();
//		BlockFace r = null;
