...
//
//	static {
//		register(ExprMinecartDerailedFlyingVelocity.class, Vec3.class,
...
//	@Nullable
//	@Override
//	public Vec3 convert(Entity entity) {
...
//							if (entity instanceof Minecart)
//								((Minecart) entity).setFlyingVelocityMod((Vec3) delta[0]);
//						}
//						break;
//					case ADD:
//						for (Entity entity : getExpr().getArray(e)) {
...
//								minecart.setFlyingVelocityMod(((Vec3) delta[0]).add(minecart.getFlyingVelocityMod()));
//							}
//						}
//						break;
//					case REMOVE:
...
//							if (entity instanceof Minecart) {
//								Minecart minecart = (Minecart) entity;
//								minecart.setFlyingVelocityMod(((Vec3) delta[0]).subtract(minecart.getFlyingVelocityMod()));
//							}
//						}
//						break;
//					default:
...
//						for (Entity entity : getExpr().getArray(e)) {
//							if (entity instanceof Minecart)
//								((Minecart) entity).setDerailedVelocityMod((Vec3) delta[0]);
//						}
//						break;
//					case ADD:
//						for (Entity entity : getExpr().getArray(e)) {
//							if (entity instanceof Minecart) {
//								Minecart minecart = (Minecart) entity;
//								minecart.setDerailedVelocityMod(((Vec3) delta[0]).add(minecart.getDerailedVelocityMod()));
//							}
//						}
//						break;
//					case REMOVE:
...
//							if (entity instanceof Minecart) {
//								Minecart minecart = (Minecart) entity;
//								minecart.setDerailedVelocityMod(((Vec3) delta[0]).subtract(minecart.getDerailedVelocityMod()));
//							}
//						}
//						break;
//					default:
