...
//		for (final AbstractContainerMenu invi : invis.getArray(e)) {
...
//		final Iterator<? extends AbstractContainerMenu> is = invis.iterator(e);
//		if (is == null || !is.hasNext())
//			return null;
//		return new Iterator<Slot>() {
//			@SuppressWarnings("null")
//			AbstractContainerMenu current = is.next();
////
//			int next = 0;
////
//			@SuppressWarnings("null")
