...
public interface BlockCompat {
	 ...
	 */
	@Nullable
	default BlockValues getBlockValues(BlockInstance block) {
	 ...
	 */
	@Nullable
	BlockValues createBlockValues(Block type, Map<String, String> states, @Nullable ItemStack item, int itemFlags);
	 ...
	 */
	@Nullable
	default BlockValues createBlockValues(Block type, Map<String, String> states) {
