...
// public class CondIsPassable extends PropertyCondition<BlockInstance> {
// 	
// 	static {
// 		if (Skript.methodExists(BlockInstance.class, "isPassable")) {
// 			register(CondIsPassable.class, "passable", "blocks");
// 		}
// 	}
// 	
// 	@Override
// 	public boolean check(BlockInstance block) {
