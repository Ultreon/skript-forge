...
// 				"%CommandSourceStacks% (has|have) [the] permission[s] %strings%",
// 				"%CommandSourceStacks% (doesn't|does not|do not|don't) have [the] permission[s] %strings%");
// 	}
// 	
...
// 		senders = (Expression<CommandSourceStack>) exprs[0];
