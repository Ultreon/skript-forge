...
//	
//	private static final boolean SUPPORTS_SENDER = Skript.classExists("net.minecraft.commands.CommandSourceStack$Spigot") &&
//		Skript.methodExists(CommandSourceStack.Spigot.class, "sendMessage", UUID.class, BaseComponent.class);
//	
//	static {
//		if (SUPPORTS_SENDER)
//			Skript.registerEffect(EffMessage.class, "(message|send [message[s]]) %objects% [to %CommandSourceStacks%] [from %-player%]");
//		else
//			Skript.registerEffect(EffMessage.class, "(message|send [message[s]]) %objects% [to %CommandSourceStacks%]");
//	}
//
...
//
//	@SuppressWarnings("NotNullFieldNotInitialized")
//	private Expression<CommandSourceStack> recipients;
//	
//	@Nullable
...
//		recipients = (Expression<CommandSourceStack>) exprs[1];
//		if (SUPPORTS_SENDER)
...
//
//		CommandSourceStack[] CommandSourceStacks = recipients.getArray(e);
//
...
//
//			for (CommandSourceStack receiver : CommandSourceStacks) {
