...
//					final Vec3 vel = dir.getDirection(((LivingEntity) shooter).getLocation()).multiply(v.doubleValue());
...
//					}
//				} else {
//					final Vec3 vel = dir.getDirection((Location) shooter).multiply(v.doubleValue());
