...
// 
// 	static {
// 		Skript.registerEvent("Damage", EvtDamage.class, LivingDamageEvent.class, "damag(e|ing) [of %-entitydata%] [by %-entitydata%]")
...
// 	
// 	private static boolean checkDamage(LivingDamageEvent e) {
