...
// 						"\tcancel event")
// 				.since("2.2-dev21");
// 		Skript.registerEvent("AbstractContainerMenu Open", SimpleEvent.class, InventoryOpenEvent.class, "inventory open[ed]")
// 				.description("Called when an inventory is opened for player.")
// 				.examples("on inventory open:",
// 						"\tclose player's inventory")
// 				.since("2.2-dev21");
// 		Skript.registerEvent("AbstractContainerMenu Close", SimpleEvent.class, InventoryCloseEvent.class, "inventory clos(ing|e[d])")
...
// 		.since("2.5");
// 		Skript.registerEvent("AbstractContainerMenu Pickup", SimpleEvent.class, InventoryPickupItemEvent.class, "inventory pick[ ]up")
