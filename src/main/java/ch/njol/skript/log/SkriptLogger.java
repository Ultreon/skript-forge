...
public abstract class SkriptLogger {
	...
	/**
	 * Sends the given formatted message to the given {@link CommandSourceStack}.
	 */
	public static void sendFormatted(CommandSourceStack CommandSourceStack, String message) {
		if (CommandSourceStack instanceof ConsoleCommandSourceStack) {
			for (String s : message.split("\n"))
				Bukkit.getConsoleSender().sendMessage(s);
		} else {
			CommandSourceStack.sendMessage(message);
		}
	}
